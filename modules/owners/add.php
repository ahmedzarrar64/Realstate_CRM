...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        $sql = "INSERT INTO owners (name, phone, email, address, preferred_contact, notes) 
                VALUES ('$name', '$phone', '$email', '$address', '$preferred_contact', '$notes')";
...
<div class="row mb-4">
    <div class="col-md-12">
        <h2><i class="fas fa-user-plus"></i> Add New Owner</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Property Owners</a></li>
                <li class="breadcrumb-item active">Add New Owner</li>
            </ol>
        </nav>
    </div>
</div>
