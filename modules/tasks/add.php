...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO tasks (owner_id, property_id, task_description, due_date, status) 
        ...
        if (executeQuery($sql)) {
            ...
            $errors[] = "Error adding task: " . mysqli_error($conn);
        }
    }
}
?>
            ...
            <div class="card-body">
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <textarea name="task_description" id="task_description" class="form-control" rows="3" required placeholder="Enter task details..."></textarea>
                    </div>
                    
                    <div class="mb-3">
                        <label for="due_date" class="form-label">Due Date <span class="text-danger">*</span></label>
                        <input type="date" name="due_date" id="due_date" class="form-control" required value="<?php echo date('Y-m-d'); ?>">
                    </div>
